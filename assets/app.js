...
const EXTRAS=[
 ["x2026_brewming.jpg",2026,"칠곡 브루밍 콘서트 7회차"],
...
const S22={ko:'소담음악회 · 작은문화공간 아트홀 소담 (2022.8.3)',en:'Sodam Concert · Arthall Sodam (3 Aug 2022)',ja:'ソダム音楽会 · アートホール・ソダム (2022.8.3)',zh:'素潭音乐会 · 素潭艺术厅 (2022.8.3)'};
const S20={ko:"부부의 날 기념 '스위트 세레나데' · 웃는얼굴아트센터 (2020.5.21)",en:"'Sweet Serenade' for Couples' Day · Smiling Face Art Center (21 May 2020)",ja:"夫婦の日記念『スイート・セレナーデ』· 笑顔アートセンター (2020.5.21)",zh:"夫妻节纪念'甜蜜小夜曲' · 笑脸艺术中心 (2020.5.21)"};
...
const VIDEOS=[
 ...
 {id:'WQwSgRvM3BE',y:2025,cat:'inv',dur:'1:03:37',t:{ko:"'겨울의 結(결)' 전체 실황",en:"'Texture of Winter' — full concert",ja:"『冬の結』全編実況",zh:"《冬之结》全场实况"},s:{ko:"젊은 현의 소리 · 대가야문화누리 가야금홀 (2025.12.9)",en:"'Sound of Young Strings' · Daegaya Munhwa Nuri, Gayageum Hall (9 Dec 2025)",ja:"若い弦の音 · 大伽倻文化ヌリ 伽倻琴ホール (2025.12.9)",zh:"青年弦乐之声 · 大伽倻文化中心 伽倻琴厅 (2025.12.9)"}},
 {id:'3dbpocGysnc',y:2023,cat:'inv',dur:'13:16',t:{ko:'라벨 — 죽은 왕녀를 위한 파반느 / 슈베르트 — 아베 마리아',en:'Ravel — Pavane pour une infante défunte / Schubert — Ave Maria',ja:'ラヴェル — 亡き王女のためのパヴァーヌ / シューベルト — アヴェ・マリア',zh:'拉威尔 — 悼念公主的帕凡舞曲 / 舒伯特 — 圣母颂'},s:{ko:"제42회 대구국제음악제 'Delight the Spirit : Emotion' (2023)",en:"42nd Daegu International Music Festival 'Delight the Spirit : Emotion' (2023)",ja:"第42回大邱国際音楽祭 'Delight the Spirit : Emotion' (2023)",zh:"第42届大邱国际音乐节 'Delight the Spirit : Emotion' (2023)"}},
 {id:'DZz-jXLLU9U',y:2022,cat:'inv',dur:'22:48',t:{ko:'베토벤 — 트리오 C장조 Op.87 (Va 이정민 · Vc 오국환 · Vc 이희수)',en:'Beethoven — Trio in C major, Op.87 (Va Lee Jung-min · Vc Oh Kuk-hwan · Vc Lee Hee-su)',ja:'ベートーヴェン — 三重奏曲 ハ長調 Op.87',zh:'贝多芬 — C大调三重奏 Op.87'},s:S22},
 {id:'aXwc-utKy2U',y:2022,cat:'inv',dur:'16:28',t:{ko:'베토벤 — 6중주 E♭장조 Op.81b (트리오 버전) (Pf 강경신 · Va 이정민 · Vc 오국환)',en:'Beethoven — Sextet in E-flat major, Op.81b (trio version) (Pf Kang Kyung-shin · Va Lee Jung-min · Vc Oh Kuk-hwan)',ja:'ベートーヴェン — 六重奏曲 変ホ長調 Op.81b (トリオ版)',zh:'贝多芬 — 降E大调六重奏 Op.81b (三重奏版)'},s:S22},
 {id:'lcyMwT1AUYw',y:2022,cat:'inv',dur:'21:55',t:{ko:'베토벤 — 첼로 소나타 3번 A장조 Op.69 (Vc 이희수 · Pf 강경신)',en:'Beethoven — Cello Sonata No.3 in A major, Op.69 (Vc Lee Hee-su · Pf Kang Kyung-shin)',ja:'ベートーヴェン — チェロ・ソナタ第3番 イ長調 Op.69',zh:'贝多芬 — A大调第三大提琴奏鸣曲 Op.69'},s:S22},
 {id:'h1r55muFI5s',y:2022,cat:'inv',dur:'7:56',t:{ko:'베토벤 — 네 손을 위한 피아노 소나타 D장조 Op.6 (Pf 배미현 · 강경신)',en:'Beethoven — Sonata in D major for Piano Four Hands, Op.6 (Pf Bae Mi-hyun · Kang Kyung-shin)',ja:'ベートーヴェン — 4手のためのピアノ・ソナタ ニ長調 Op.6',zh:'贝多芬 — D大调四手联弹钢琴奏鸣曲 Op.6'},s:S22},
 {id:'LeOJ98YMkVA',y:2021,cat:'inv',dur:'57:20',t:{ko:"대구아티스트위크 시즌3 '품다' 전체 실황 (비발디 · 차이콥스키 · 슈만)",en:"Daegu Artist Week Season 3 'Embrace' — full concert (Vivaldi · Tchaikovsky · Schumann)",ja:"大邱アーティストウィーク シーズン3『品다』全編実況",zh:"大邱艺术家周 第三季《品다》全场实况"},s:{ko:'대구콘서트하우스 (2021)',en:'Daegu Concert House (2021)',ja:'大邱コンサートハウス (2021)',zh:'大邱音乐厅 (2021)'}},
 {id:'7qUzShSbuKg',y:2020,cat:'inv',dur:'6:06',t:{ko:'사운드 오브 뮤직 메들리',en:'The Sound of Music Medley',ja:'サウンド・オブ・ミュージック・メドレー',zh:'音乐之声组曲'},s:S20},
 {id:'Qhskt5w9vRQ',y:2020,cat:'inv',dur:'3:56',t:{ko:'Joyful, Joyful (기쁘고 기쁘도다)',en:'Joyful, Joyful',ja:'Joyful, Joyful',zh:'Joyful, Joyful'},s:S20},
 {id:'h_ioWtYjEzs',y:2020,cat:'inv',dur:'27:19',t:{ko:"수성아트피아 '예술인 氣 살리기 프로젝트' 전체 실황 (사운드 오브 뮤직 · 쇼스타코비치 · 드보르작)",en:"Suseong Artpia 'Artist Revival Project' — full concert (Sound of Music · Shostakovich · Dvořák)",ja:"寿城アートピア『芸術人 氣 プロジェクト』全編実況",zh:"寿城艺术中心'艺术家振气计划'全场实况"},s:{ko:'수성아트피아 (2020)',en:'Suseong Artpia (2020)',ja:'寿城アートピア (2020)',zh:'寿城艺术中心 (2020)'}},
...
/* ===================== Home: ENTER intro + BGM + slideshow (v26) ===================== */
...
en:{
 ...
 a_p1:"<strong>Ensemble BOAZ</strong> began as a male string ensemble of Keimyung University graduates, opening with a sold-out debut concert in January 2015. With first prizes at numerous chamber music competitions and the Busan Mayor's Award, the ensemble has grown through its annual concert series.",
 ...
 b26:"<b>6th Annual Concert 'No.6'</b> (Suseong Artpia) · Lobby Concert 'Rhythm of the Lobby – Piazzolla' · <b>AMICONE with Ensemble BOAZ</b> · Goryeong-in Young Artists Project 'Never Ending Story' · Chilgok Brewming Concert, 7th session (Crema)",
 ...
 d26_1:"6th Annual Concert 'No.6' — W. A. Mozart · Nam Jung-hun · M. Bruch (Suseong Artpia)",d26_2:"Lobby Concert 'Rhythm of the Lobby – Piazzolla' (Suseong Artpia Grand Theater Lobby, 2 Jul 2026)",d26_3:"AMICONE with Ensemble BOAZ — Library Cool-Classic: A Midsummer Journey of Art Songs (Suseong Beomeo Library, Kim Man-yong·Park Su-nyeon Hall, 30 Jul 2026)",d26_4:"Goryeong-in Young Artists Project Season 4 — Musical Play 'Never Ending Story: The Unending Song of Youth' (Daegaya Munhwa Nuri, Ureuk Hall, 29 Aug 2026)",d26_5:"Chilgok Brewming Concert, 7th session — Brew + Bloom (23 Sep 2026, Café Crema, Chilgok · Chilgok Culture & Tourism Foundation)",
 ...
 ex:["Chilgok Brewming Concert · 7th Session","Goryeong Youth Project 'Echo of Dreams'","14th Park Tae-jun Memorial Concert","Underscore for Cinema","Beyond The Sequence","Spring Concert","Goryeong Youth Project 'Byeol Jjibu Jjabu'","Film Music Concert","Dongseongno Renaissance Project","13th Park Tae-jun Memorial Concert","Korea Through Its Songs","For Viola","12th Park Tae-jun Memorial Concert","Dalseo Festival","Rising Artists Project","Night of Beethoven","Talk to You Project Concert","Blink of Summer","Daegu Arts Center 'Start-up'","Suseong Artpia Artist Support Project","Sound of Music","Festival Academia · Spain","Talk to You","Sujak Concert","La Vita è Bella","Daegu Spring Ensemble Festival","'Romanza'","3rd Annual Concert 'Track3'","3Days Concert for Strings","Season 2"],
...
de:{
 ...
 a_p1:'<strong>Ensemble BOAZ</strong> entstand als Streicherensemble von Absolventen der Keimyung-Universität und debütierte im Januar 2015 mit einem ausverkauften Konzert. Mit ersten Preisen bei zahlreichen Kammermusikwettbewerben und dem Preis des Bürgermeisters von Busan wuchs das Ensemble durch seine jährliche Konzertreihe.',
...
es:{
 ...
 a_p1:'<strong>Ensemble BOAZ</strong> nació como un ensamble de cuerdas de graduados de la Universidad Keimyung y debutó en enero de 2015 con un concierto con entradas agotadas. Con primeros premios en numerosos concursos de música de cámara y el Premio del Alcalde de Busan, el conjunto ha crecido con su serie anual de conciertos.',
...
ja:{
 ...
 a_p1:'<strong>Ensemble BOAZ</strong>は啓明大学校出身の男性弦楽アンサンブルとして始まり、2015年1月、全席完売の創団演奏会で初舞台を飾りました。数々の室内楽コンクールでの1位、釜山市長賞などで実力を証明し、毎年の定期演奏会とともに成長してきました。',
 ...
 b26:'<b>第6回定期演奏会『No.6』</b>（水城アートピア小劇場）・ロビーコンサート『ロビーのリズム – ピアソラ』・<b>AMICONE with Ensemble BOAZ</b>・青年芸術家 高霊 in プロジェクト『Never Ending Story』・漆谷ブルーミングコンサート 第7回（クレマ）',b25:'慶北文化財団<b>『Beyond Four Seasons』</b>（慶州芸術の殿堂）・『冬の結』・朴泰俊記念音楽会',b24:'<b>第5回定期演奏会『THE BOAZ』</b>（大邱コンサートハウス）・<b>初日本公演</b>（神戸・大阪）',b23:'<b>大邱広域市指定団体に選定</b>・大邱国際音楽祭・『The BOAZ（慶北）』設立',b22:'オーケストラ規模に拡大・DSAC <b>Opera with BOAZ</b>（達西アートセンター）',b21:'大邱アーティストウィーク<b>『抱く（품다）』</b>（大邱コンサートハウス）',b20:'新世界百貨店企画演奏・水城アートピア芸術家プロジェクト',b19:'<b>『真夏の夜の夢』</b>共同企画コンサート（大邱コンサートハウス）',b18:'スペイン<b>テネリフェ国際フェスティバル</b>招請演奏',b17:'<b>第4回定期演奏会『LUXURY TIME』</b>',b16:'第3回定期演奏会『Track3』・大邱コンサートハウス火曜企画演奏',b15:'<b>創団演奏会（全席完売）</b>・グローバルコンクール室内楽1位・釜山市長賞',b14:'Ensemble BOAZ 創団',
 d26_1:'第6回定期演奏会『No.6』— W. A. モーツァルト・ナム・ジョンフン・M. ブルッフ（水城アートピア小劇場）',d26_2:'ロビーコンサート『ロビーのリズム – ピアソラ』（2026.7.2、水城アートピア大劇場ロビー）',d26_3:'AMICONE with Ensemble BOAZ — 図書館クールクラシック『真夏の歌曲の旅』（2026.7.30、水城区立汎魚図書館 キム・マンヨン／パク・スニョンホール）',d26_4:'青年芸術家 高霊 in プロジェクト Season 4 — 音楽劇『Never Ending Story：終わらない青春の歌』（2026.8.29、大伽耶文化ヌリ 于勒ホール）',d26_5:'漆谷ブルーミングコンサート 第7回 — Brew + Bloom（2026.9.23、漆谷 クレマ・漆谷文化観光財団）',
...
zh:{
 ...
 a_p1:'<strong>Ensemble BOAZ</strong>由启明大学毕业生组成的男性弦乐团起步，2015年1月以全场售罄的创团音乐会登上首个舞台。曾在多项室内乐比赛中获得第一名、釜山市长奖等，通过每年的定期音乐会不断成长。',
 ...
 b26:"<b>第六届定期音乐会'No.6'</b>（寿城Artpia小剧场）·大厅音乐会'大厅的节奏 – 皮亚佐拉'·<b>AMICONE with Ensemble BOAZ</b>·青年艺术家 高灵 in 项目'Never Ending Story'·漆谷Brewming音乐会 第7场（Crema）",b25:"庆北文化财团<b>'Beyond Four Seasons'</b>（庆州艺术殿堂）·'冬之结'·朴泰俊纪念音乐会",b24:"<b>第五届定期音乐会'THE BOAZ'</b>（大邱音乐厅）·<b>首次日本公演</b>（神户·大阪）",b23:"<b>入选大邱广域市指定团体</b>·大邱国际音乐节·成立'The BOAZ（庆北）'",b22:'扩编至管弦乐团规模·DSAC <b>Opera with BOAZ</b>（达西艺术中心）',b21:"大邱艺术家周<b>'拥抱（품다）'</b>（大邱音乐厅）",b20:'新世界百货企划演出·寿城Artpia艺术家项目',b19:'<b>《仲夏夜之梦》</b>联合企划音乐会（大邱音乐厅）',b18:'受邀<b>西班牙特内里费国际音乐节</b>演出',b17:"<b>第四届定期音乐会'LUXURY TIME'</b>",b16:"第三届定期音乐会'Track3'·大邱音乐厅周二企划演出",b15:'<b>创团音乐会（全场售罄）</b>·全球比赛室内乐第一名·釜山市长奖',b14:'Ensemble BOAZ 创团',
 d26_1:"第六届定期音乐会'No.6' — W. A. 莫扎特·南廷勋·M. 布鲁赫（寿城Artpia小剧场）",d26_2:"大厅音乐会'大厅的节奏 – 皮亚佐拉'（2026.7.2，寿城Artpia大剧场大厅）",d26_3:"AMICONE with Ensemble BOAZ — 图书馆Cool-Classic'仲夏艺术歌曲之旅'（2026.7.30，寿城区立泛鱼图书馆 金万龙·朴寿年厅）",d26_4:"青年艺术家 高灵 in 项目 Season 4 — 音乐剧'Never Ending Story：永不落幕的青春之歌'（2026.8.29，大伽倻文化Nuri 于勒厅）",d26_5:"漆谷Brewming音乐会 第7场 — Brew + Bloom（2026.9.23，漆谷 Crema · 漆谷文化观光财团）",
 ...
 p:["第六届定期音乐会'No.6'","青年艺术家 高灵 in 项目'Never Ending Story'",'AMICONE with Ensemble BOAZ·仲夏艺术歌曲之旅','大厅音乐会·大厅的节奏 – 皮亚佐拉','冬之结','Beyond Four Seasons','首次日本公演·神户/大阪',"第五届定期音乐会'THE BOAZ'",'大邱国际音乐节','歌剧之旅',"大邱艺术家周'拥抱'",'仲夏夜之梦','特内里费国际音乐节·西班牙',"第四届定期音乐会'LUXURY TIME'",'创团音乐会（第一届）'],
 ex:['漆谷Brewming音乐会 第7场',"高灵青年项目'梦之回声'",'第14届朴泰俊纪念音乐会','Underscore for Cinema','Beyond The Sequence','春之音乐会',"高灵青年项目'星星扁扁'",'电影音乐会','东城路文艺复兴项目','第13届朴泰俊纪念音乐会','以歌曲看大韩民国','For Viola','第12届朴泰俊纪念音乐会','达西艺术节','新锐艺术家发掘项目','贝多芬之夜','Talk to You 项目音乐会','Blink of Summer',"大邱文化艺术会馆'Start-up'",'寿城Artpia艺术家支援项目','Sound of Music','Festival Academia·西班牙','Talk to You','秀作音乐会','La Vita è Bella','大邱春季室内乐节',"'Romanza'","第三届定期音乐会'Track3'",'3Days Concert for Strings','Season 2'],
...
th:{
 ...
 a_p1:'<strong>Ensemble BOAZ</strong> เริ่มต้นจากวงเครื่องสายชายของศิษย์เก่ามหาวิทยาลัยคเยมยอง เปิดตัวในเดือนมกราคม 2015 ด้วยคอนเสิร์ตที่บัตรขายหมด คว้ารางวัลที่ 1 จากการแข่งขันดนตรีเชมเบอร์หลายรายการ และรางวัลนายกเทศมนตรีปูซาน เติบโตผ่านคอนเสิร์ตประจำปีอย่างต่อเนื่อง',
